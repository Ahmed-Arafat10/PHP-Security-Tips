...
While You Are Using [ Include($page); ] In Your Code, This Redirected Page
May Contains Any Script Or Shell That Execute Malicious Code

- Its like that:
# http://localhost:8080/PHP_Security/5.php?page=http://www.google.com
...
- Turn It To Off To Be
[allow_url_include=OFF]
- Then Restart Apache Server

- Now O/P In Browser Will Be :
# Warning: include(): http:// wrapper is disabled in the server configuration by allow_url_include=0 in C:\xampp\htdocs\PHP_Security\5.php on line 7
